...
from services.article_services import get_articles
    ...
    async def process_articles():
        try:
            ...
            for ticker in TICKERS:
                articles = get_articles(ticker, date_today, date_today)
            ...
            error_message = "An error occurred in views.process_articles"
